...
<ParamField query="GetFamily($getFamilyId: ID!)" type="ID" required>
...
It returns the array of the <Tooltip tip="The User object contains all the information about a user.">(User)[www.google.com]</Tooltip> object.
</ParamField>
...
This is date the family was created and registered. It is also a float equivalent to what (Date.prototype.getTime())[https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/getTime] returns.
</ParamField>
